...
if ($np!=$rp)
{
  ...
  header("location:change_password_db.php?msg=$msg");
}
...
$update = mysql_query("UPDATE staffregister SET password='$np' WHERE rollno='$staffid'");
if($update)
{
   $msg = "Password Successfully updated in your account(".$staffid.")";
